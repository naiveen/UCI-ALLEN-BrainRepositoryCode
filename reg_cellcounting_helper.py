...
if __name__ == '__main__':
    ...
    if not os.path.isdir(output_dir):
        ...
        from registration import axisAlign, elastixRegistration, laplacianRegistration
        fixedImagePath = args.fixedImagePath 
        either of these 
        fixedImagePath = os.path.join(template_dir, "average_template_25m.nii")
        movingImagePath = ""
        axisAlignedDataPath  = axisAlign(movingImagePath)
        elastixRegistrationOutput  = elastixRegistration(fixedImagePath, movingImagePath)
        laplacianRefinedOutput = laplacianRegistration(fixedImagePath, elastixRegistrationOutput)
